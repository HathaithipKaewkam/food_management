...
class Constants {
  //Primary color
  static var primaryColor = const Color(0xFF4A90E2);
  static var blackColor = const Color.fromARGB(255, 0, 0, 0);
  static var whiteColor = const Color.fromARGB(255, 255, 255, 255);

  //Onboarding texts
  static var titleOne = "Reduce Food Waste";
