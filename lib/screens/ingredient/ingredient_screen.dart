...
class _IngredientScreenState extends State<IngredientScreen> {
  ...
  if (user != null) {
    ...
    setState(() {
      ingredientList = snapshot.docs.map((doc) {
        return Ingredient.fromMap(doc.data()); // ใช้ฟังก์ชันจาก Map
      }).toList();
      isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    // แยกวัตถุดิบหมดอายุและไม่หมดอายุ
    final expiredIngredients = ingredientList
        .where((ingredient) => ingredient.expDate.isBefore(DateTime.now()))
        .toList();

    final nonExpiredIngredients = ingredientList
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text(
                                'You have ${ingredientList.where((ingredient) => ingredient.expDate.isBefore(DateTime.now())).toList().length} expired items',
                        ...
                        Padding(
                          ...
                          child: ingredientList
                                  .where((ingredient) => ingredient.expDate
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: AssetImage(ingredientList
                                                .where((ingredient) =>
                                                    ingredient.expDate.isBefore(
                                                        DateTime.now()))
                                                .first
                                                .imageUrl),
                                          ),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${ingredientList.where((ingredient) => ingredient.expDate.isBefore(DateTime.now())).first.quantity} ${ingredientList.where((ingredient) => ingredient.expDate.isBefore(DateTime.now())).first.unit}',
                                                  style: const TextStyle(
                                                    fontWeight: FontWeight.bold,
                                                    color: Colors.grey,
                                                    fontSize: 14,
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  'Expired ${ingredientList.where((ingredient) => ingredient.expDate.isBefore(DateTime.now())).first.expDate.difference(DateTime.now()).inDays.abs()} days ago!',
                                                  style: const TextStyle(
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.bold,
                                                    color: Colors.red,
